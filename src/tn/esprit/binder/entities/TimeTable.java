...
public class TimeTable {
   ...
   public TimeTable(String day,String seance1, String seance2, String seance3, String seance4, String seance5) {
    ...
    public TimeTable(int idClasse, String pdfT) {
        this.idClasse = idClasse;
        this.pdfT = pdfT;
    }
    ...
    public String getPdfT() {
        return pdfT;
    }

    public void setPdfT(String pdfT) {
        this.pdfT = pdfT;
    }

    @Override
    public String toString() {
        return "TimeTable{" + "seance1=" + seance1 + ", seance2=" + seance2 + ", seance3=" + seance3 + ", seance4=" + seance4 + ", seance5=" + seance5 + ", id=" + id + ", idClasse=" + idClasse + ", day=" + day + ", subject=" + subject + ", idSubject=" + idSubject + ", pdfT=" + pdfT + '}';
    }
